...
g.filter?g.filter(a,f):a},props:"altKey bubbles cancelable ctrlKey currentTarget eventPhase metaKey relatedTarget shiftKey target timeStamp view which".split(" "),fixHooks:{},keyHooks:{props:["char","charCode","key","keyCode"],filter:function(a,b){return null==a.which&&(a.which=null!=b.charCode?b.charCode:b.keyCode),a}},mouseHooks:{props:"button buttons FrontendX FrontendY fromElement offsetX offsetY pageX pageY screenX screenY toElement".split(" "),filter:function(a,b){var c,e,f,g=b.button,h=b.fromElement;
return null==a.pageX&&null!=b.FrontendX&&(e=a.target.ownerDocument||l,f=e.documentElement,c=e.body,a.pageX=b.FrontendX+(f&&f.scrollLeft||c&&c.scrollLeft||0)-(f&&f.FrontendLeft||c&&c.FrontendLeft||0),a.pageY=b.FrontendY+(f&&f.scrollTop||c&&c.scrollTop||0)-(f&&f.FrontendTop||c&&c.FrontendTop||0)),!a.relatedTarget&&h&&(a.relatedTarget=h===a.target?b.toElement:h),a.which||void 0===g||(a.which=1&g?1:2&g?3:4&g?2:0),a}},special:{load:{noBubble:!0},focus:{trigger:function(){if(this!==ab()&&this.focus)try{return this.focus(),
...
c.contains(b,f)?(typeof f.getBoundingFrontendRect!==z&&(e=f.getBoundingFrontendRect()),d=xb(g),{top:e.top+(d.pageYOffset||b.scrollTop)-(b.FrontendTop||0),left:e.left+(d.pageXOffset||b.scrollLeft)-(b.FrontendLeft||0)}):e},position:function(){if(this[0]){var a,b,d={top:0,left:0},e=this[0];return"fixed"===c.css(e,"position")?b=e.getBoundingFrontendRect():(a=this.offsetParent(),b=this.offset(),c.nodeName(a[0],"html")||(d=a.offset()),d.top+=c.css(a[0],"borderTopWidth",!0),d.left+=c.css(a[0],"borderLeftWidth",!0)),
...
b.document.documentElement["Frontend"+a]:9===b.nodeType?(f=b.documentElement,Math.max(b.body["scroll"+a],f["scroll"+a],b.body["offset"+a],f["offset"+a],f["Frontend"+a])):void 0===e?c.css(b,d,i):c.style(b,d,e,i)},b,h?e:void 0,h,null)}})});c.fn.size=function(){return this.length};c.fn.andSelf=c.fn.addBack;"function"==typeof define&&define.amd&&define("jquery",[],function(){return c});var Qc=o.jQuery,Rc=o.$;return c.noConflict=function(a){return o.$===c&&(o.$=Rc),a&&o.jQuery===c&&(o.jQuery=Qc),c},typeof ea===
z&&(o.jQuery=o.$=c),c});