	...
	{	
		...
		if($.isFunction($.fn.timepicker))
		{
			$(".timepicker").each(function(i, el)
			{
				var $this = $(el),
					opts = {
						template: attrDefault($this, 'template', 'dropdown'),
						defaultTime: attrDefault($this, 'defaultTime', 'current'),
						showMeridian: attrDefault($this, 'showMeridian', false),
						minuteStep: attrDefault($this, 'minuteStep', 10),
						secondStep: attrDefault($this, 'secondStep', 10),
                        appendWidgetTo: attrDefault($this, 'appendWidgetTo', '#timepicker-container')
					},
					$n = $this.next(),
					$p = $this.prev();
