...
if (!DevExpress.MOD_WIDGETS_BASE) {
    ...
    (function($, DX, undefined) {
        ...
        DX.registerComponent(SCROLLABLE, DX.DOMComponent.inherit({
            ...
            _toggleRTLDirection: function(rtl) {
                this.callBase(rtl);
                if (rtl)
                    this.scrollTo({left: this.scrollWidth() - this.FrontendWidth()})
            },
            ...
            FrontendHeight: function() {
                return this._$container.height()
            },
            scrollHeight: function() {
                return this.content().height()
            },
            FrontendWidth: function() {
        ...
        var SwipeDownNativeScrollViewStrategy = ui.NativeScrollableStrategy.inherit({
                ...
                handleInit: function(e) {
                    ...
                    if (this._state === STATE_RELEASED && this._location === 0) {
                        this._startFrontendY = events.eventData(e.originalEvent).y;
                        this._state = STATE_TOUCHED
                    }
                },
                handleMove: function(e) {
                    this.callBase(e);
                    this._deltaY = events.eventData(e.originalEvent).y - this._startFrontendY;
    ...
    (function($, DX, undefined) {
        ...
        var SlideDownNativeScrollViewStrategy = ui.NativeScrollableStrategy.inherit({
                ...
                _updateDimensions: function() {
                    this._scrollOffset = this._$container.prop("scrollHeight") - this._$container.prop("FrontendHeight");
                    this._containerSize = {
                        height: this._$container.prop("FrontendHeight"),
                        width: this._$container.prop("FrontendWidth")
                    };
                ...
                _isReachBottom: function(location) {
                    this._scrollContent = this._$container.prop("scrollHeight") - this._$container.prop("FrontendHeight");
            ...
            _renderScrollHandler: function() {
                ...
                $input.on(events.addNamespace("dxpointermove", this.NAME), function(e) {
                    var scrollTopPos = $input.scrollTop(),
                        scrollBottomPos = $input.prop("scrollHeight") - $input.prop("FrontendHeight") - scrollTopPos;
    ...
    (function($, DX, undefined) {
        ...
        DX.registerComponent("dxList", ui.CollectionContainerWidget.inherit({
            ...
            FrontendHeight: function() {
                return this._scrollView.FrontendHeight()
            },
            scrollHeight: function() {
            ...
            scrollToItem: function(itemElement) {
                ...
                var itemPosition = $itemElement.position().top,
                    ...
                    FrontendHeight = this.FrontendHeight();
                if (scrollTop <= itemPosition && itemBottom <= scrollTop + FrontendHeight)
                    return;
                if (scrollTop > itemPosition)
                    this.scrollTo(itemPosition);
                else
                    this.scrollTo(itemPosition + itemHeight - FrontendHeight)
            }
        }))
    })(jQuery, DevExpress);
    ...
    (function($, DX, undefined) {
        ...
        registerDecorator("reorder", "default", ListEditDecorator.inherit({
            ...
            _cacheScrollData: function() {
                ...
                this._FrontendHeight = this._list.FrontendHeight()
            },
            _scrollTop: function() {
            ...
            _toggleScroll: function(pointerPosition) {
                if (this._scrollHeight <= this._FrontendHeight)
                    return;
                var minOffset = this._elementHeight * .7,
                    topOffset = this._FrontendHeight - (pointerPosition - this._scrollTop()),
            ...
            scrollFinished: function() {
                var scrollTop = this._scrollTop(),
                    ...
                    rejectScrollBottom = scrollTop >= this._scrollHeight - this._FrontendHeight && this._stepSize > 0;
