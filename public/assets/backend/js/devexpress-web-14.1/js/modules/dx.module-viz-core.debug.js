...
if (!DevExpress.MOD_VIZ_CORE) {
    ...
    (function($, DX) {
        ...
        var getBoundingFrontendRect = function(element) {
                var i,
                    resultRect,
                    rect,
                ...
                if (tagName === 'div') {
                    if (element.childNodes.length > 0) {
                        ...
                        for (i = 0; i < element.childNodes.length; i++) {
                            rect = getBoundingFrontendRect(element.childNodes[i]);
                            if (!rect)
                                continue;
                    ...
                    resultRect = {};
                    rect = element.getBoundingFrontendRect();
                    for (i = 0; i < points.length; i++) {
                    ...
                    resultRect = element.getBoundingFrontendRect();
                return resultRect
            };
        var BaseVmlElement = {
                isVml: function() {
                ...
                _getBBox: function() {
                    var width,
                        ...
                        parent;
                    try {
                        rect = getBoundingFrontendRect(element);
                        width = rect.right - rect.left;
                        height = rect.bottom - rect.top;
                        parent = this.element.parentNode || this.renderer.getRoot().element;
                        parentRect = parent.getBoundingFrontendRect();
